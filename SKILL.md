---
name: boluobao
description: "Plan and create Boluobao-style visuals from user-provided text, data, or images: choose illustration-worthy passages and image count, generate article illustrations, social covers, multilingual handwritten notes, compact charts or tables, or reconstruct a supplied image in the warm colored-pencil journal style. Use for requests such as ‘为我的内容进行配图’, ‘生成社媒封面’, ‘做一张多语便签’, ‘把这些数据做成柱状图’, or ‘帮我将这个图片用boluobao进行设计’; do not use for photorealistic retouching or dense spreadsheet reporting."
---
